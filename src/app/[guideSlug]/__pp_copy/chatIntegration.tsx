  ...
  return (
    <div className="chat-integration">
      ...
      <style jsx>{`
        ...
        .typing-message { display: flex; align-items: center; gap: 4px; }
        .typing-indicator { display: flex; gap: 3px; }
        .typing-indicator span { width: 6px; height: 6px; background: #999; border-radius: 50%; animation: typing 1.4s infinite ease-in-out; }
        ...
        .message-input button { background: linear-gradient(90deg,rgba(112, 15, 101, 1) 0%, rgba(92, 10, 92, 1) 50%, rgba(19, 117, 114, 1) 100%); color: white; border: none; padding: 10px 16px; border-radius: 6px; cursor: pointer; font-size: 14px; }
        .message-input button:hover:not(:disabled) { background: linear-gradient(90deg,rgba(112, 15, 101, 0.8) 0%, rgba(92, 10, 92, 0.8) 50%, rgba(19, 117, 114, 0.8) 100%); }
